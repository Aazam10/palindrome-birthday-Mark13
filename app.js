...
function clickHandler() {
    ...
    if (bdayStr !== '') {
        ...
        if (isBirthDatePalindrome) {
            ...
            resultRef.innerText=`Your Birthdate is not a palindrome.The next palindrome date is ${palindromeDate.day}-${palindromeDate.month} -${palindromeDate.year}, you missed by ${noOfDays} Days`
        }
